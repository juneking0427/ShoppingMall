...
<div id="pop_wrap">
	...
	<div id="pop_container2" class="pop_container2">
    	<!-- content -->
		<form id="editor_upimage" name="editor_upimage" action="/resources/se/quick_photo_uploader/photo_uploader/file_uploader.jsp" method="post" enctype="multipart/form-data" onSubmit="return false;">
        <div id="pop_content2">
    ...
    <div id="pop_footer">
	    <div class="btn_area">
            <a href="javascript:fn_imageUp();"><img src="/resources/se/quick_photo_uploader/photo_uploader/img/btn_confirm.png" width="49" height="28" alt="확인" id="btn_confirm"></a>
            <a href="javascript:window.close();"><img src="/resources/se/quick_photo_uploader/photo_uploader/img/btn_cancel.png" width="48" height="28" alt="취소" id="btn_cancel"></a>
        </div>
    </div>
    <!-- //footer -->
</div>
