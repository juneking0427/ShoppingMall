...
<!-- 	<link type="text/css" rel="stylesheet" href="./../resources/css/hancom.css" /> -->
	...
	<script type="text/javascript">
		function fn_boradDetail(no){
			$('#board_idx').val(no);
			$('#cForm').attr("action","/mainDetail.do").submit();
		}
	</script>
 </head>
...
<div id="wrap">
	<div>
        ...
        <table>
            ...
            <thead>
           		<tr><p> HOME > 모니터 > 24형 모니터</p></tr>
            </thead>
        	<tbody>
        		<c:forEach var="i" items="${selectList }">
       			<tr>
       				<td><td align="center"><a href="#"><img src="#" width="95px" height="87px"/></a></td>
       				<td width="650px"><a href="javascript:fn_boradDetail('${i.BOARD_IDX }')"><b>${i.TITLE }</b><br /><br /> ${i.EXPLAIN_OPTION }</a></td>
       				<td align="center">판매가격<br /><br /><b>${i.PRICE }</b>
       			</tr>
        		</c:forEach>
        		<tr>
