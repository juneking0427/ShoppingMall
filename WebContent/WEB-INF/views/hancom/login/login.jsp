...
<script type="text/javascript">
	...
	function pageAction(){
		if(checkLogin()){
			...
			getAjax("/checkLogin.do", jData, setAlert);
		} 
	}
...
<div id="contents">
	<div class="inner">
		...
		<fieldset>
			<legend>Hancom 로그인</legend>
			<div class="login_sect">
				<div class="login_bx">
					<div class="login_form">
						<p>Logdin</p>
						<div class="inp_area">
							<input type="text" id="MBER_ID" name="member_id" placeholder="아이디" class="admin_id" value=""/>
							<input type="password" id="MBER_PW" name="member_pw" class="pwd" placeholder="비밀번호" value=""/>
						</div>
